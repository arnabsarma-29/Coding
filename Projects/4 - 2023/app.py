...
app.layout = html.Div([
    html.H1('Stock Price Predictor', style={"textAlign": "center", "margin_top":"8px"}),
    html.H2('Created By - Arnab & Satya', style={"textAlign": "center", "margin_top":"8px"}),
